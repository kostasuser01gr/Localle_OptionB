...
echo '============================================================'
echo 'LOCALLE A8 STRICT E2E WATCHER'
echo 'A8 EMAIL: PREPARED — NOT SENT BY THIS SCRIPT'
echo 'Press Send in the prefilled Gmail compose after recording begins.'
echo '============================================================'
exec node "$ROOT/tools/localle_a8_final_demo.js" "$BASELINE"
