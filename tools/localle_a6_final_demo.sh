...
echo '============================================================'
echo 'LOCALLE A7 STRICT E2E WATCHER'
echo 'A7 EMAIL: PREPARED — NOT SENT BY THIS SCRIPT'
